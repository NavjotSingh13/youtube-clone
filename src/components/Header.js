    ...
    <div className="grid grid-flow-col p-5 m-2 shadow-lg">
      <div className="flex flex-row col-span-1">
        <img
          className="h-8"
          alt="Menu"
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQGqXiU5tLjAaptQnUkfoXqPCoovjUmc3b5yg"
        />
        <img
          className="h-8 mx-2"
          alt="Menu"
      ...
      <div className="col-span-10 text-center">
        <input type="text" className="border-4 border-sky-500 mx-5" />
        <button className="bg-indigo-500 px-5 text-neutral-50	">Search</button>
      </div>
